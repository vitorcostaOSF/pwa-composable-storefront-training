...
ContentSearch.getProps = async () => {
    let clientID = '264f0d69-a6b7-4001-a2df-20d025275702';
    let siteID = 'RefArch';
    let contentResult
    //Make a call to the URL substituting Key Values from table
    const res = await fetch(
        `http://localhost:3000/mobify/proxy/ocapi/s/${siteID}/dw/shop/v20_2/content_search?q=about&client_id=${clientID}`
    )
    if (res.ok) {
